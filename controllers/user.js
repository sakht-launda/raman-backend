...
exports.sendinvite = async (req, res, next) => {
    ...
    if (user) {
        ...
        var transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
                user: 'ramandeepsinghsaini55@gmail.com',//replace with your email
                pass: 'Depender1'
            },
            port: 465,
            host: 'smtp.gmail.com'
        ...
        */
        var mailOptions = {
            from: 'ramandeepsinghsaini55@gmail.com',
            to: req.body.userEmailId,
            subject: `Join Splitbill`,
            html: '<p> Hi </p> <p>Splitbill. and Start splitting your expenses.</p/>',
